...
\DoxyCodeLine{\Hypertarget{_2io__multisols__example3_2main_8c_source_l00120}00120\ \ \ \ \ \ \ \textcolor{keywordflow}{else}\ \{}
\DoxyCodeLine{\Hypertarget{_2io__multisols__example3_2main_8c_source_l00121}00121\ \ \ \ \ \ \ \ \ printf(\textcolor{stringliteral}{"{}Unexpected\ value\ for\ solution\ type\(\backslash\)n"{}});}
\DoxyCodeLine{\Hypertarget{_2io__multisols__example3_2main_8c_source_l00122}00122\ \ \ \ \ \ \ \ \ exit(EXIT\_FAILURE);}
\DoxyCodeLine{\Hypertarget{_2io__multisols__example3_2main_8c_source_l00123}00123\ \ \ \ \ \ \ \}}
\DoxyCodeLine{\Hypertarget{_2io__multisols__example3_2main_8c_source_l00124}00124\ }
\DoxyCodeLine{\Hypertarget{_2io__multisols__example3_2main_8c_source_l00125}00125\ \ \ \ \ \ \ \textcolor{keywordflow}{if}\ (\ \mbox{\hyperlink{API__functions__s_8c_a4d3f5e957ddecdd91170e056565dc29a}{MMGS\_Get\_ithSols\_inSolsAtVertices}}(mmgSol,i,sols)\ !=1\ )\ exit(EXIT\_FAILURE);}
\DoxyCodeLine{\Hypertarget{_2io__multisols__example3_2main_8c_source_l00126}00126\ }
\DoxyCodeLine{\Hypertarget{_2io__multisols__example3_2main_8c_source_l00127}00127\ \ \ \ \ \ \ \textcolor{comment}{/*\ Set\ the\ ith\ solution\ in\ the\ new\ structure\ */}}
\DoxyCodeLine{\Hypertarget{_2io__multisols__example3_2main_8c_source_l00128}00128\ \ \ \ \ \ \ \textcolor{keywordflow}{if}\ (\ \mbox{\hyperlink{API__functions__s_8c_aba86ff7e3cb55349706a17ceccbbdc88}{MMGS\_Set\_ithSols\_inSolsAtVertices}}(tmpSol,i,sols)\ !=1\ )\ exit(EXIT\_FAILURE);}
\DoxyCodeLine{\Hypertarget{_2io__multisols__example3_2main_8c_source_l00129}00129\ \ \ \ \ \}}
\DoxyCodeLine{\Hypertarget{_2io__multisols__example3_2main_8c_source_l00130}00130\ \ \ \ \ \textcolor{keywordflow}{else}\ \{}
\DoxyCodeLine{\Hypertarget{_2io__multisols__example3_2main_8c_source_l00131}00131\ \ \ \ \ \ \ \textcolor{comment}{/*\ Get\ the\ ith\ solution\ array\ vertex\ by\ vertex\ */}}
\DoxyCodeLine{\Hypertarget{_2io__multisols__example3_2main_8c_source_l00132}00132\ \ \ \ \ \ \ \textcolor{keywordflow}{if}\ (\ typSol[i-\/1]\ ==\ \mbox{\hyperlink{libmmgtypes_8h_a68ad1024791ce7577a19c0ee1dde271eac973ca2285269e2b57940636b3435004}{MMG5\_Scalar}}\ )}
\DoxyCodeLine{\Hypertarget{_2io__multisols__example3_2main_8c_source_l00133}00133\ \ \ \ \ \ \ \ \ sols\ =\ (\textcolor{keywordtype}{double}*)\ calloc(1,\ \textcolor{keyword}{sizeof}(\textcolor{keywordtype}{double}));}
\DoxyCodeLine{\Hypertarget{_2io__multisols__example3_2main_8c_source_l00134}00134\ \ \ \ \ \ \ \textcolor{keywordflow}{else}\ \textcolor{keywordflow}{if}\ (\ typSol[i-\/1]\ ==\ \mbox{\hyperlink{libmmgtypes_8h_a68ad1024791ce7577a19c0ee1dde271ea24a3de787b59de108d77429a58f39774}{MMG5\_Vector}}\ )}
\DoxyCodeLine{\Hypertarget{_2io__multisols__example3_2main_8c_source_l00135}00135\ \ \ \ \ \ \ \ \ sols\ =\ (\textcolor{keywordtype}{double}*)\ calloc(3,\ \textcolor{keyword}{sizeof}(\textcolor{keywordtype}{double}));}
\DoxyCodeLine{\Hypertarget{_2io__multisols__example3_2main_8c_source_l00136}00136\ \ \ \ \ \ \ \textcolor{keywordflow}{else}\ \textcolor{keywordflow}{if}\ (\ typSol[i-\/1]\ ==\ \mbox{\hyperlink{libmmgtypes_8h_a68ad1024791ce7577a19c0ee1dde271eaa9d1aaab7bff21ecaa2feb214d1ce3a3}{MMG5\_Tensor}}\ )\ \{}
\DoxyCodeLine{\Hypertarget{_2io__multisols__example3_2main_8c_source_l00137}00137\ \ \ \ \ \ \ \ \ sols\ =\ (\textcolor{keywordtype}{double}*)\ calloc(6,\ \textcolor{keyword}{sizeof}(\textcolor{keywordtype}{double}));}
\DoxyCodeLine{\Hypertarget{_2io__multisols__example3_2main_8c_source_l00138}00138\ \ \ \ \ \ \ \}}
\DoxyCodeLine{\Hypertarget{_2io__multisols__example3_2main_8c_source_l00139}00139\ \ \ \ \ \ \ \textcolor{keywordflow}{else}\ \{}
\DoxyCodeLine{\Hypertarget{_2io__multisols__example3_2main_8c_source_l00140}00140\ \ \ \ \ \ \ \ \ printf(\textcolor{stringliteral}{"{}Unexpected\ value\ for\ solution\ type\(\backslash\)n"{}});}
\DoxyCodeLine{\Hypertarget{_2io__multisols__example3_2main_8c_source_l00141}00141\ \ \ \ \ \ \ \ \ exit(EXIT\_FAILURE);}
...
\DoxyCodeLine{\Hypertarget{_2io__multisols__example3_2main_8c_source_l00144}00144\ \ \ \ \ \ \ \textcolor{keywordflow}{for}\ (\ j=1;\ j<=np;\ ++j\ )\ \{}
\DoxyCodeLine{\Hypertarget{_2io__multisols__example3_2main_8c_source_l00145}00145\ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{if}\ (\ \mbox{\hyperlink{API__functions__s_8c_a89ee37c8491fa42ca89b000320806ad4}{MMGS\_Get\_ithSol\_inSolsAtVertices}}(mmgSol,i,sols,j)\ !=1\ )\ exit(EXIT\_FAILURE);}
\DoxyCodeLine{\Hypertarget{_2io__multisols__example3_2main_8c_source_l00146}00146\ }
\DoxyCodeLine{\Hypertarget{_2io__multisols__example3_2main_8c_source_l00147}00147\ \ \ \ \ \ \ \ \ \textcolor{comment}{/*\ Set\ the\ ith\ solution\ vertex\ by\ vertex\ in\ the\ new\ structure\ */}}
\DoxyCodeLine{\Hypertarget{_2io__multisols__example3_2main_8c_source_l00148}00148\ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{if}\ (\ \mbox{\hyperlink{API__functions__s_8c_a725735b8921c9a8273487a874892f43f}{MMGS\_Set\_ithSol\_inSolsAtVertices}}(tmpSol,i,sols,j)\ !=1\ )\ exit(EXIT\_FAILURE);}
\DoxyCodeLine{\Hypertarget{_2io__multisols__example3_2main_8c_source_l00149}00149\ \ \ \ \ \ \ \}}
\DoxyCodeLine{\Hypertarget{_2io__multisols__example3_2main_8c_source_l00150}00150\ }
\DoxyCodeLine{\Hypertarget{_2io__multisols__example3_2main_8c_source_l00151}00151\ \ \ \ \ \}}
\DoxyCodeLine{\Hypertarget{_2io__multisols__example3_2main_8c_source_l00152}00152\ \ \ \ \ free(sols);\ sols\ =\ NULL;}
\DoxyCodeLine{\Hypertarget{_2io__multisols__example3_2main_8c_source_l00153}00153\ \ \ \}}
\DoxyCodeLine{\Hypertarget{_2io__multisols__example3_2main_8c_source_l00154}00154\ }
\DoxyCodeLine{\Hypertarget{_2io__multisols__example3_2main_8c_source_l00155}00155\ }
\DoxyCodeLine{\Hypertarget{_2io__multisols__example3_2main_8c_source_l00159}00159\ \ \ \textcolor{comment}{/*\ save\ the\ mesh\ */}}
\DoxyCodeLine{\Hypertarget{_2io__multisols__example3_2main_8c_source_l00160}00160\ \ \ \textcolor{keywordflow}{if}\ (\ \mbox{\hyperlink{inout__s_8c_a41b588168fba8de32f83d723e6d40a9c}{MMGS\_saveMesh}}(mmgMesh,fileout)\ !=\ 1\ )}
\DoxyCodeLine{\Hypertarget{_2io__multisols__example3_2main_8c_source_l00161}00161\ \ \ \ \ exit(EXIT\_FAILURE);}
\DoxyCodeLine{\Hypertarget{_2io__multisols__example3_2main_8c_source_l00162}00162\ }
\DoxyCodeLine{\Hypertarget{_2io__multisols__example3_2main_8c_source_l00163}00163\ \ \ \textcolor{comment}{/*s\ ave\ the\ solutions\ array\ */}}
\DoxyCodeLine{\Hypertarget{_2io__multisols__example3_2main_8c_source_l00164}00164\ \ \ \textcolor{keywordflow}{if}\ (\ \mbox{\hyperlink{inout__s_8c_afaf47275ed341eff052124efa405e237}{MMGS\_saveAllSols}}(mmgMesh,\&tmpSol,fileout)\ !=\ 1\ )}
\DoxyCodeLine{\Hypertarget{_2io__multisols__example3_2main_8c_source_l00165}00165\ \ \ \ \ exit(EXIT\_FAILURE);}
\DoxyCodeLine{\Hypertarget{_2io__multisols__example3_2main_8c_source_l00166}00166\ }
\DoxyCodeLine{\Hypertarget{_2io__multisols__example3_2main_8c_source_l00168}00168\ \ \ \mbox{\hyperlink{API__functions__s_8c_a701ec871c9f0aa7c8086ba74e217e331}{MMGS\_Free\_all}}(\mbox{\hyperlink{libmmgtypes_8h_aacbd03d96b61ae96d7f41ef83ef4c4b7}{MMG5\_ARG\_start}},}
\DoxyCodeLine{\Hypertarget{_2io__multisols__example3_2main_8c_source_l00169}00169\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \mbox{\hyperlink{libmmgtypes_8h_a13b5408584e0e7410c424fdbeae368c8}{MMG5\_ARG\_ppMesh}},\&mmgMesh,\mbox{\hyperlink{libmmgtypes_8h_a98bbcd80dd5f234f4d6a852862fe4c3f}{MMG5\_ARG\_ppSols}},\&tmpSol,}
\DoxyCodeLine{\Hypertarget{_2io__multisols__example3_2main_8c_source_l00170}00170\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \mbox{\hyperlink{libmmgtypes_8h_a98bbcd80dd5f234f4d6a852862fe4c3f}{MMG5\_ARG\_ppSols}},\&mmgSol,}
\DoxyCodeLine{\Hypertarget{_2io__multisols__example3_2main_8c_source_l00171}00171\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \mbox{\hyperlink{libmmgtypes_8h_a13d6070b21dd2b77154afb86198808e6}{MMG5\_ARG\_end}});}
\DoxyCodeLine{\Hypertarget{_2io__multisols__example3_2main_8c_source_l00172}00172\ }
\DoxyCodeLine{\Hypertarget{_2io__multisols__example3_2main_8c_source_l00173}00173\ \ \ free(\mbox{\hyperlink{API__functionsf__3d_8c_a539b7c333f2633a43adfe1fcb5b0430b}{filename}});}
\DoxyCodeLine{\Hypertarget{_2io__multisols__example3_2main_8c_source_l00174}00174\ \ \ \mbox{\hyperlink{API__functionsf__3d_8c_a539b7c333f2633a43adfe1fcb5b0430b}{filename}}\ =\ NULL;}
\DoxyCodeLine{\Hypertarget{_2io__multisols__example3_2main_8c_source_l00175}00175\ }
\DoxyCodeLine{\Hypertarget{_2io__multisols__example3_2main_8c_source_l00176}00176\ \ \ free(fileout);}
\DoxyCodeLine{\Hypertarget{_2io__multisols__example3_2main_8c_source_l00177}00177\ \ \ fileout\ =\ NULL;}
\DoxyCodeLine{\Hypertarget{_2io__multisols__example3_2main_8c_source_l00178}00178\ }
\DoxyCodeLine{\Hypertarget{_2io__multisols__example3_2main_8c_source_l00179}00179\ \ \ \textcolor{keywordflow}{return}(0);}
\DoxyCodeLine{\Hypertarget{_2io__multisols__example3_2main_8c_source_l00180}00180\ \}}
