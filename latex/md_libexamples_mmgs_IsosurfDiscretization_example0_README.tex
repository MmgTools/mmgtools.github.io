\hypertarget{md_libexamples_mmgs_IsosurfDiscretization_example0_README_autotoc_md105}{}\doxysection{I/ Implementation}\label{md_libexamples_mmgs_IsosurfDiscretization_example0_README_autotoc_md105}
We read the mesh and level-\/set values at the mesh nodes and then, we discretize the implicit function and optimize the mesh.\hypertarget{md_libexamples_mmgs_IsosurfDiscretization_example0_README_autotoc_md106}{}\doxysection{II/ Compilation}\label{md_libexamples_mmgs_IsosurfDiscretization_example0_README_autotoc_md106}
