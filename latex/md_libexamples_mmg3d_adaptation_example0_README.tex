\hypertarget{md_libexamples_mmg3d_adaptation_example0_README_autotoc_md68}{}\doxysection{I/ Implementation}\label{md_libexamples_mmg3d_adaptation_example0_README_autotoc_md68}
...
\end{DoxyEnumerate}\hypertarget{md_libexamples_mmg3d_adaptation_example0_README_autotoc_md69}{}\doxysubsection{example0\+\_\+a}\label{md_libexamples_mmg3d_adaptation_example0_README_autotoc_md69}
We read mesh and solution files using the {\bfseries{MMG3\+D\+\_\+load\+Mesh}} and {\bfseries{MMG3\+D\+\_\+load\+Sol}} functions. Results are saved using {\bfseries{MMG3\+D\+\_\+save\+Mesh}} and {\bfseries{MMG3\+D\+\_\+save\+Sol}} functions.\hypertarget{md_libexamples_mmg3d_adaptation_example0_README_autotoc_md70}{}\doxysubsection{example0\+\_\+b}\label{md_libexamples_mmg3d_adaptation_example0_README_autotoc_md70}
The mesh and solution are hard coded. ~\newline
 They are build in MMG5 format using API functions and are recovered by the same way. ~\newline
 We show how to recover the mesh/sol by writting it in a file.\hypertarget{md_libexamples_mmg3d_adaptation_example0_README_autotoc_md71}{}\doxysection{II/ Compilation}\label{md_libexamples_mmg3d_adaptation_example0_README_autotoc_md71}
