\hypertarget{md_libexamples_mmgs_adaptation_example0_README_autotoc_md91}{}\doxysection{I/ Implementation}\label{md_libexamples_mmgs_adaptation_example0_README_autotoc_md91}
...
\end{DoxyEnumerate}\hypertarget{md_libexamples_mmgs_adaptation_example0_README_autotoc_md92}{}\doxysubsection{example0\+\_\+a}\label{md_libexamples_mmgs_adaptation_example0_README_autotoc_md92}
We read mesh and solution files using the {\bfseries{MMGS\+\_\+load\+Mesh}} and {\bfseries{MMGS\+\_\+load\+Sol}} functions. Results are saved using {\bfseries{MMGS\+\_\+save\+Mesh}} and {\bfseries{MMGS\+\_\+save\+Sol}} functions.\hypertarget{md_libexamples_mmgs_adaptation_example0_README_autotoc_md93}{}\doxysubsection{example0\+\_\+b}\label{md_libexamples_mmgs_adaptation_example0_README_autotoc_md93}
The mesh and solution are hard coded. ~\newline
 They are build in MMG5 format using API functions and are recovered by the same way. ~\newline
 We show how to recover the mesh/sol.\hypertarget{md_libexamples_mmgs_adaptation_example0_README_autotoc_md94}{}\doxysection{II/ Compilation}\label{md_libexamples_mmgs_adaptation_example0_README_autotoc_md94}
